...
cd "$(dirname "$0")"
status=0
for t in test_portable test_phrasing test_postprocess test_traceability test_answerable test_structure test_subjects test_subjects_nonvacuous test_subject_persistence \
